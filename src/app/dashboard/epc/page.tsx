...
import { Zap, Package, Building2, Landmark, ArrowRight } from "lucide-react";
import Link from "next/link";

export const metadata: Metadata = {
  title: "EPC Lookup by Postcode - Energy Performance Certificates | Fabrick",
  description:
    "Search Energy Performance Certificates for any UK postcode - ratings, SAP scores, building fabric data. Explore domestic property energy efficiency from the DLUHC open data register.",
  keywords: [
    "EPC lookup",
  ...
  openGraph: {
    title: "EPC Lookup by Postcode - Energy Performance Certificates | Fabrick",
    description:
      "Search Energy Performance Certificates for any UK postcode - ratings, SAP scores, building fabric data.",
